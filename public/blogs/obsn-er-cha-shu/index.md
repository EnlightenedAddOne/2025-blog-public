> 来源：Obsidian/10-学业与考试/考研/wangdao-data-structure-main/ch5/binary-tree/二叉树.md
...
![二叉树的五种基本形态](/blogs/obsn-er-cha-shu/five-basic-form-of-binary-tree.jpg)

![三个结点的二叉树有多少种](/blogs/obsn-er-cha-shu/binary-tree-with-3-nodes.jpg)
...
![二叉树与度为2的有序树的区别](/blogs/obsn-er-cha-shu/binary-tree-vs-ordered-tree-with-degree-2.jpg)
...
![二叉排序树](/blogs/obsn-er-cha-shu/binary-sort-tree.jpg)

### 3.4. 平衡二叉树

树上**任意结点**的左子树和右子树的深度之差不超过 $1$。

![平衡二叉树](/blogs/obsn-er-cha-shu/balanced-binary-tree.jpg)

## 4. 二叉树的性质

- 非空二叉树上的叶子结点数等于度为 $2$ 的结点数加 $1$，即 $n_0=n_2+1$

![二叉树性质一](/blogs/obsn-er-cha-shu/nature-1-of-binary-tree.jpg)

- 非空二叉树上第 $k$ 层上至多有 $2^{k-1}$ 个结点（$k \geq 1$）。
- 高度为 $h$ 的二叉树至多有 $2^h-1$ 个结点（$h \geq 1$）。

![二叉树性质二和性质三](/blogs/obsn-er-cha-shu/nature-2-and-3-of-binary-tree.jpg)
...
![二叉树性质四](/blogs/obsn-er-cha-shu/nature-4-of-binary-tree.jpg)

![二叉树性质四2](/blogs/obsn-er-cha-shu/nature-4-2-of-binary-tree.jpg)

- 具有 $n$ 个（$n>0$）结点的完全二叉树的高度为 $\left \lfloor log_2n+1 \right \rfloor$ 或 $\left \lceil log_2(n+1) \right \rceil$。

![二叉树性质五](/blogs/obsn-er-cha-shu/nature-5-of-binary-tree.jpg)
