> 来源：Obsidian/10-学业与考试/考研/wangdao-data-structure-main/ch2/线性表.md
...
> - 函数名和参数的形式、命名都可改变（参考：严蔚敏《数据结构》）
> - 什么时候要传入引用 `&`：对参数的修改结果需要 "带回来"（C++ 语法）

> [!question] 为什么要实现对数据结构的基本操作？
>
